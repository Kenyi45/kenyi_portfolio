...
const Card: React.FC<CardProps> = ({
  ...
  const variantClasses: Record<'default' | 'elevated' | 'bordered' | 'gradient', string> = {
    ...
    elevated: isPaper
      ...
      : 'bg-ink-raised/95 border border-ink-line shadow-card-ink hover:shadow-brutal-steel hover:-translate-y-0.5 text-neutral-100',
    bordered: isPaper
    ...
    return (
      <div
        className={clsx(
          ...
          isPaper ? 'hover:shadow-medium' : 'shadow-card-ink hover:shadow-brutal-steel',
          className
        )}
        style={style}
        {...props}
